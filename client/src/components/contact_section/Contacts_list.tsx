...
function ContactsList({...props}: IContacProps) {
    return (
        <div
            ...
            key={props.id}
        >
            {props.svgIcone === 'Mail' ? <Mail className="text-cream w-[26px] h-[26px]"/> : null}
            {props.svgIcone === 'Phone' ? <Phone className="text-cream w-[26px] h-[26px]"/> : null}
            {props.svgIcone === 'MapPin' ? <MapPin className="text-cream w-[26px] h-[26px]"/> : null}
            <Paragraph
                text={props.titel}
