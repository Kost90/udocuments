...
function HeadingSection() {
  return (
    <SectionContainer className="bg-sectionBg h-full w-full pt-32 md:pt-[185px] pb-28 border-b border-b-slate-400" ariaLabelledby="section-heading">
      ...
      <motion.h1
        ...
        >
          Досвідчені фахівці в галузі права
        </motion.h1>
        <MotionParagraph
          initial="initial"
          whileInView="whileInView"
