...
function FormSection() {
  return (
    <SectionContainer className="bg-light-gradient w-full h-full py-20 md:py-32 border-b border-b-slate-400" ariaLabelledby="form-section-title">
      <div className="flex flex-col gap-10 justify-center items-center md:flex-row md:justify-between md:items-start">
        <div className="flex flex-col justify-start items-start gap-4 md:gap-6">
          ...
          <Paragraph text="Для консультації звертайтесь за такими контактами:" />
